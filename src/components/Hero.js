import { Box,
  ...
  Text,
  Button,
  Stack, Image } from '@chakra-ui/react';
...
const Hero = () => {
 ...
 <Heading
                ...
                <Text color={'white.500'}>
                  Earn daily $KADABRA coins, gain early access to our NFT portfolio tracker, exclusive access to our Sandbox metaverse and more...
                </Text>
                <Stack
                  direction={'column'}
                  spacing={3}
